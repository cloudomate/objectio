...
impl CrushMap {
    ...
    ///
    /// The key is a colon-joined prefix of the topology tuple up to and
    /// including the requested level — so nodes sharing a key at that
    /// level share all enclosing levels too.
