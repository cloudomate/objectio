...
pub struct AddTableRequest {
    pub schema: String,
    pub name: String,
    /// Table type: "delta" for Delta Lake tables, "uniform" for Iceberg tables
    #[serde(default)]
    pub table_type: String,
    /// For delta tables: S3 bucket containing Delta Lake files
    #[serde(default)]
    pub bucket: String,
    /// For delta tables: path within bucket to Delta table root
    #[serde(default)]
    pub path: String,
    /// For uniform/iceberg tables: warehouse name
    #[serde(default)]
    pub warehouse: String,
    /// For uniform/iceberg tables: full namespace (dot-separated)
    #[serde(default)]
