...
pub struct IcebergCatalog {
    ...
    /// Warehouse scope (empty = default/legacy). Set per-request via `with_warehouse()`.
    warehouse: String,
}
...
impl IcebergCatalog {
    ...
    /// Create a warehouse-scoped catalog view.
    #[must_use]
    pub fn with_warehouse(&self, warehouse: &str) -> Self {
        Self {
    ...
    /// Get a clone of the meta client for direct RPC calls.
